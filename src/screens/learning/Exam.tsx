...
export function Exam({ navigation, route }: Props) {
    ...
    useEffect(() => {
        ...
        void (async () => {
            try {
                const res = await learningService.updateExamAttempt({
                    dni,
                    exam_id: examId,
                });
                if (cancelled) return;
    ...
    const submit = async () => {
        ...
        try {
            ...
            queryService.manageErrors(res);
            if (!res.error) {
                Alert.alert("Cuidarte", res.msg || "Examen enviado.");
    ...
    return (
        <View style={styles.page}>
            ...
            <View style={styles.top}>
                ...
                <View
                    style={[styles.timerPill, !onTime && styles.timerPillOff]}
                >
            ...
            {!onTime ? (
                ...
                >
                    ...
                    <TouchableOpacity
                        style={styles.btn}
                        onPress={() =>
                            Alert.alert("Cuidarte", "¿Finalizar examen?", [
