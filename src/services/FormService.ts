...
export class FormService {
  ...
  async getGeneralInfo(): Promise<FormsList> {
    return queryService.executeQuery<FormsList>('get', '/getGeneralInfo', {});
  }
  ...
  async getFormatsList(data: { user_id: number }): Promise<unknown> {
    return queryService.executeQuery<unknown>('get', '/getFormatsList', data);
  }
  ...
  async getListRecords(data: {
    ...
    return queryService.executeQuery<unknown>('post', '/getListRecords', data);
  }

  async getListActions(data: Record<string, unknown>): Promise<unknown> {
    return queryService.executeQuery<unknown>('post', '/getListActions', data);
  }

  async getListEffectiveness(data: Record<string, unknown>): Promise<unknown> {
    return queryService.executeQuery<unknown>('post', '/getListEffectiveness', data);
  }
  ...
  async getPamolsaRecords(data: {
    ...
    return queryService.executeQuery<unknown>('post', '/getPamolsaRecords', data);
  }

  async getActionDetail(data: { action_id: number }): Promise<unknown> {
    return queryService.executeQuery<unknown>('post', '/getActionDetail', data);
  }
  ...
  async saveEffectiveness(data: unknown): Promise<unknown> {
    return queryService.executeQuery<unknown>('post', '/saveEffectiveness', data);
  }
  ...
  saveDataPamolsaAction(_data: unknown): Promise<unknown> {
    ...
    return queryService.executeQuery<unknown>('post', '/pamolsa-action', _data);
  }
  ...
  async saveDataLocal(): Promise<void> {
    await localStorage.setItem(FORMS_SAVED_KEY, JSON.stringify(this.forms_saved_local));
  }
